...
public class RenderTextureViewActivity extends AppCompatActivity implements TextureView.SurfaceTextureListener, SurfaceTexture.OnFrameAvailableListener {
    ...
    private void openCamera() {
        try {
            ...
            if (ActivityCompat.checkSelfPermission(RenderTextureViewActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                return;
            }
        ...
        try {
            ...
            mCameraDevice.createCaptureSession(Arrays.asList(surface), new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigured(@NonNull CameraCaptureSession session) {
                    ...
                    if (GLESTool.isTablet(RenderTextureViewActivity.this) && orientationLiveData.getValue() != null) {
