...
public class OriginalVideoFilter extends BaseVideoFilter {
    ...
    public void onInit(int VWidth, int VHeight) {
        ...
        glProgram = GLESTool.createProgram(vertexShader_filter, fragmentshader_filter);
    ...
    @Override
    public void onDraw(int cameraTexture, GlFrameBuffer mFrameBuffer) {
...
//        GLES20.glDrawElements(GLES20.GL_TRIANGLES, mDrawIndecesBuffer.limit(), GLES20.GL_UNSIGNED_SHORT, mDrawIndecesBuffer);
//        GLES20.glFinish();
//        onAfterDraw();
